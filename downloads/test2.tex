...
%=------------------------授權-----------------------=%
\input{./../KEHUEISIN/downloads/ Creative Commons.tex}
\newpage
%=------------------------致謝-----------------------=%
\input{./../KEHUEISIN/downloads/ACKNOWLEDGMENTS.tex}
\newpage
%=------------------------摘要-----------------------=%
\input{./../KEHUEISIN/downloads/abstract.tex}
\newpage
%=------------------------目錄----------------------=%
...
\end{center}
%=-------------------------內容----------------------=%
\input{./../KEHUEISIN/downloads/ introduction_orig.tex}
\input{./../KEHUEISIN/downloads/ introduction_orig.tex}
